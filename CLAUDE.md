...
- The chooser, the loading overlay, and the failure card share that vocabulary: one flat ground, mono meta, 3px corners, and colour reserved for the two things that carry meaning — rain (blue) and the rain window itself (amber). Nothing on any of the four screens may reintroduce a decorative palette; the page is read, not looked at.
